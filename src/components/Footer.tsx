    ...
    return (
        <footer className="container" id="sobre">
            ...
            <div>
                ...
                <nav className="icons">
                    <a
                        href="https://github.com/danielBRTanimacao/II-projeto-extensao-faculdade"
                        target="blanck"
                    >
                        <svg
                    ...
                    <a
                        href="https://www.instagram.com/pascom.saopauloapostolo?igsh=d2sxZm41d2psZTQw"
                        target="blanck"
                    >
                        <svg
                            xmlns="http://www.w3.org/2000/svg"
            ...
            <hr />
            <h5 className="bottom-copyright">
                © {date.getFullYear()} Salão paroquial
            </h5>
        </footer>
    );
};
